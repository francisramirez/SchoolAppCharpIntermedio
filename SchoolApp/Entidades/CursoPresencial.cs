...
namespace SchoolApp.Entidades
{
    public sealed class CursoPresencial : Curso
    {
        ...
        {
            Console.WriteLine($"El estudiante {estudiante.Nombre} se ha inscrito en el curso presencial.");
        ...
        {
            return base.ObtenerInformacionCompleta() + $", Ubicación: {Ubicacion}, Duración: {Duracion} horas";
        }
    }
    {
    }
